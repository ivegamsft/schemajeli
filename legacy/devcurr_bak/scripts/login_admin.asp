...
If Request.Form("Password") = "nurse" Then
Session.Timeout = 60
...
Dim strUserId
  ...
  Session("EmailAddr") = TRIM(rs.Fields(2)) & "." & TRIM(rs.Fields(3)) & "@navistar.com"
...
Set objCDOMail = Server.CreateObject("CDONTS.NewMail")
	...
	objCDOMail.Body = strUserId & " is logging in at " & TIME & " as " & Session("UserName") & " with " & Session("UAuth") & " authority." 
    objCDOMail.Send
    If err <> 0 then
...
Else
     session("error") = "9999-You did not enter the proper password.<BR>Please try again."
