...
<a name="top"></a>
  <tr>
    <td colspan="2" width="100%" height="40" align="center"><font color="<%=arypagecolors(0)%>"face="Verdana"><b>Search Elements</b>
...
<!--FORM ACTION="elmbrs.asp" METHOD="POST" NAME="search_elems" onsubmit="return Search_Check(this)">-->
<FORM ACTION="query_result.asp?RelObject=Element" METHOD="POST" NAME="search_elems" onsubmit="return Search_Check(this)">
  <tr>
