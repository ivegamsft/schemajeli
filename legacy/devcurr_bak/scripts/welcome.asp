...
<TABLE BORDER="0" WIDTH="100%" CELLSPACING="0" CELLPADDING="0" BGCOLOR="<%=aryPageColors(7)%>">
 <TR>
...
<TABLE BORDER="0" WIDTH="100%" ALIGN="center">
 ...
 <TR>
    <TD>
    <A HREF="http://wwwnio.navistar.com/dbagroup/rdbms.htm" TARGET="_blank">Navistar DBA Standards Page</A>
    </TD>
    <TD>
    <A HREF="http://www-datadmn.itsi.disa.mil" TARGET="_blank">DOD Data Dictionary Standards page</A>
    </TD>
</TR>

<TR>
    <TD>
    <A HREF="http://wwwnio.navistar.com/edw/edwspdfs/dapweb.pdf" TARGET="_blank">Data Acquisition & Preparation Overview</A>
    </TD>
    <TD>
    <A HREF="http://www.marketplace.unisys.com/urep/" TARGET="_blank">Unisys&reg;-UREP</A>
    </TD>
 </TR>    
