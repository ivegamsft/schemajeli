	...
	setDefaultNavBarMenuColor("black", "white", "red");
	...
	addNavBarSubMenu("Search","Standard Abbreviations","search_stdabbr.asp");
	...
	addNavBarSubMenu("Maintain","Add/Manitain Databases","add_db_nme.asp");
	...
	addNavBarSubMenu("Help", "Using the Repository", "javascript:OpenHelp(\"HowTo\")");
	addNavBarSubMenu("Help", "Searching for Objects", "javascript:OpenHelp(\"Search\")");
	addNavBarSubMenu("Help", "Generating Reports", "javascript:OpenHelp(\"Reports\")");
	addNavBarSubMenu("Help", "Maintaining Objects", "javascript:OpenHelp(\"Maintain\")");
	addNavBarSubMenu("Help", "Administering Objects", "javascript:OpenHelp(\"Admin\")");
	addNavBarSubMenu("Help", "Support", "javascript:OpenHelp(\"Support\")");
	addNavBarSubMenu("Help", "Codes", "javascript:OpenHelp(\"Codes\")");
	addNavBarSubMenu("Help", "Procedures", "javascript:OpenHelp(\"Procs\")");
	addNavBarSubMenu("Help", "Return to Main Page", "welcome.asp");
