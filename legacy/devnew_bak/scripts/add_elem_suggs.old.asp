...
<TD wrap=no BGCOLOR="<%=strBackColor%>"><FONT SIZE="2" FACE="Verdana"><% =aryCurElementDetails(3) %></FONT>
</TD>
...
<TR>
<TD  valign=top colspan=2 BGCOLOR="<%=strPageBackColor%>"><FONT SIZE="2" FACE="Verdana">
<h5 TITLE="Click here to show or hide element description" style="cursor:hand" onClick="ExpandCollapse(document.all[this.sourceIndex+1])">Click here to show/hide Element Description...</h5>
<span style="display:none" style=&{head};>
<% =aryCurElementDetails(13) %>
</span>
<TD valign=top colspan=3 BGCOLOR="<%=strPageBackColor%>"><FONT SIZE="2" FACE="Verdana">
<h5 TITLE="Click here to show or hide business and column names"  style="cursor:hand" onClick="ExpandCollapse(document.all[this.sourceIndex+1])">Click here to show/hide Business and Column Names...</h5>
<span style="display:none" style=&{head};>
<% =aryCurElementDetails(0)%>;&nbsp;&nbsp;&nbsp; 
<% =aryCurElementDetails(2)%>
</span> 
</td>
</TR>
<%Next%>
