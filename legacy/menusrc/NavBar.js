...
strNavBar = 
	"<DIV ID='idNavBar' STYLE='background-color:transparent;width:100%;text-align:center; font:'Courier New';>" +
...
function addSubMenu(MenuID, SubMenuStr, SubMenuURLStr, TargetStr, bNavBarMenu) {
	...
	if (intIndex <= 0) {
		...
		strNavBar += "<HR  STYLE='position:absolute;left:0;top:0;color:" + cColor1 + "' SIZE=1>";
		strNavBar += "<DIV STYLE='position:relative;left:0;top:8;'>";
	}
