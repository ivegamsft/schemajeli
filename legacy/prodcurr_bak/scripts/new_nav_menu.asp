...
<BODY BGCOLOR="<%=strMenuBackColor%>" text="<%=strMenuTextColor%>" marginwidth="0" marginheight="0" leftmargin="0" topmargin="0">
...
<!----------Search Menu---------->
  ...
  <FONT face="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
    <a CLASS="menu" href=new_nav_menu.asp  onMouseOver="dropit2(SearchMenu);event.cancelBubble=true;return false">Search</A></b></font>
  </span>
  </span>
  </layer>
  </ilayer>
...
<!----------Report Menu---------->
  ...
  <ilayer height=35px>
  <layer visibility=show>
  <span class=iewrap1 onMouseOut="hidemenu(SearchMenu)">
...
<!----------Help Menu---------->
  ...
  <div id=SearchMenu style="position:absolute;left:0;top:0;layer-background-color:black;
      ...
      text-align:left; overflow:clip; text-indent:0" onmouseout="hidemenu(SearchMenu)">
  <script language="JavaScript1.2">
  if (document.all)
  ...
  <script language="JavaScript1.2">
  if (document.layers){
  document.HelpMenu.captureEvents(Event.MOUSEOUT)
  document.HelpMenu.onMouseOut=hidemenu
  }
  </script>
</BODY>
</HTML> 