...
<% If strMenuSel = "Search" then %>   
     ...
     <IMG SRC="../images/arrow.gif" BORDER="0" HSPACE="0" VSPACE="0">
     <A CLASS="current" TITLE="Select an object to search for from the selection box">Search</A>|
     </FONT>
<%   Else  %>
     <FONT FACE="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
     <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="search">      
     <A CLASS="reg" HREF="nav_menu.asp?Menu=Search" TITLE="Click to search for objects"
     onMouseOver=ArrowOn(1) onMouseOut=ArrowOff(1)>
     Search</A>|
     </FONT>
<% End If %>
...
<% Else  %>
     <FONT FACE="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
     <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="reports">      
     <A CLASS="reg" HREF="nav_menu.asp?Menu=Reports" TITLE="Click to report on an object"
       onMouseOver=ArrowOn(2) onMouseOut=ArrowOff(2)>
       Reports</A>|
     </FONT>
<% End If
...
<%    Else  %>
         <FONT FACE="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
         <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="maintain">      
         <A CLASS="reg" HREF="nav_menu.asp?Menu=Maintain" TITLE="Click to maintain objects"
           onMouseOver=ArrowOn(3) onMouseOut=ArrowOff(3)>
           Maintain</A>|
         </FONT>
         <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="spacer">
<%    End If 
   Else 
      If Session("UAuth")="ADMN" Then
         If strMenuSel = "Maintain" then %>   
            <FONT face="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
            <IMG SRC="../images/arrow.gif"><A CLASS="current" TITLE="Select an object to maintain from the selection list">Maintain</A>|
            </FONT>
<%       Else  %>
            <FONT FACE="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
            <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="maintain">      
...
<%       End If 
         ...
         If strMenuSel = "Administration" then %>   
             <FONT face="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
             <IMG SRC="../images/arrow.gif"><A CLASS="current" TITLE="Select an adminstrative function from the selection box">Administration</A>|
             </FONT>
<%       Else  %>
             <FONT FACE="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
             <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="admin" ID="admin">      
             <A CLASS="reg" HREF="nav_menu.asp?Menu=Administration" TITLE="Click for the adminstration menu"
              onMouseOver=ArrowOn(4) onMouseOut=ArrowOff(4)>
             Administration</A>|
             </FONT>
<%       End If 
      Else %> 
      <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="spacer2">
      <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="spacer3">
<%    End if
   End If
...
<% Else  %>
    <FONT FACE="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
    <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="help">      
    <A CLASS="reg" HREF="nav_menu.asp?Menu=Help" TITLE="Click for the help menu"
      onMouseOver=ArrowOn(5) onMouseOut=ArrowOff(5)>
     Help</A>|
    </FONT>
<% End if%> 
    <FONT FACE="Verdana" size="1" COLOR="<%=strMenuTextColor%>">
    <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="exit">      
    <A CLASS="exit" HREF="exit.asp" TARGET="_top" TITLE="Exit the Navistar Repository"
     onMouseOver=ArrowOn(6) onMouseOut=ArrowOff(6)>
     Exit</A>|
     <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="exitspace">
     <IMG SRC="../images/blank17x13.gif" BORDER="0" HSPACE="0" VSPACE="0" NAME="exitspace2">
    </FONT>
    <IMG SRC="../images/arrow.gif">
